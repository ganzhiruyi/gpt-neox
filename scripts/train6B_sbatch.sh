...
#SBATCH -o ../workspace/6B/%x-%j.log # output and error log file names (%x for job id)
#SBATCH -e ../workspace/6B/%x-%j.err # output and error log file names (%x for job id)

NNODES=24
GPUS_PER_NODE=8

CODE_ROOT='../'
CONFIG_ROOT='../workspace/6B'
MODEL_CONFIG="6B.yml"
